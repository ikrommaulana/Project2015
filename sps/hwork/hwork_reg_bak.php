...
<?php //} ?>        
		...
		<td id="mytabletitle" width="60%"><a href="#" onClick="formsort('stu.name','<?php echo "$nextdirection";?>')" title="Sort"><?php echo strtoupper($lg_name);?></a></strong></td>
		<td id="mytabletitle" width="15%" align="center">STATUS</td>
		<td id="mytabletitle" width="15%" align="center">TANGGAL DIKUMPULKAN</td>
</tr>
...
<?php
		...
		while($row=mysql_fetch_assoc($res)){
			...
			$sex=$row['sex'];
			$sta=$row['sta'];
			if($sta=='0'){$sta='Blm Di Cek';}elseif($sta=='1'){$sta='Sdh Di Cek';}else($sta="");
			$senddt=$row['submitdt'];
