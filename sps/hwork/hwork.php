	...
	$op=$_POST['op'];
		...
		if (count($del)>0) {
			for ($i=0; $i<count($del); $i++) {
				$id=$del[$i];
				$sql="select * from hwork where id='$id'";
	            $res=mysql_query($sql)or die("query failed:".mysql_error());
    	        $row=mysql_fetch_assoc($res);
        	    $sid=$row['sch_id'];
				$clslevel=$row['level'];
			
			$sql="delete from hwork_stu where xid=$id";
		      	mysql_query($sql)or die("query failed:".mysql_error());
				
				
		      	$sql="delete from hwork where id=$id";
		      	mysql_query($sql)or die("query failed:".mysql_error());
			}
		}
...
<div id="mypanel">
	<div id="mymenu" align="center">
		<a href="../adm/my_ses_cls.php?<?php echo "year=$year";?>" id="mymenuitem"><img src="../img/goback.png"><br>Back</a>
						...
						<div id="mymenu_space">&nbsp;&nbsp;</div>
        <a href="<?php echo "../hwork/hwork_reg.php?year=$year&sid=$sid&clscode=$cls&subcode=$sub";?>" id="mymenuitem"><img src="../img/new.png"><br>New</a>
						<div id="mymenu_space">&nbsp;&nbsp;</div>
						<div id="mymenu_seperator"></div>
						<div id="mymenu_space">&nbsp;&nbsp;</div>
...
<select name="year" onChange="document.myform.submit()" style="font-size:18px; font-weight:bold;">
 ...
 <div id="mytitle2"><?php echo $lg_student_task;?> <?php echo $lg_subject;?> : <?php echo $subname;?> <?php echo $year;?> </div>
 <table width="100%" cellspacing="0" cellpadding="5px" style="font-size:12px;">
  <tr>
	...
	<td id="mytabletitle" style="border-left:none;" width="7%" align="center"><?php echo $lg_date_give;?></td>
    <td id="mytabletitle" style="border-left:none;" width="7%" align="center"><?php echo $lg_date_hwork;?></td>
    <td id="mytabletitle" style="border-left:none;" width="7%" align="center"><?php echo $lg_type;?> Tugas</td>
    <td id="mytabletitle" style="border-left:none;" width="30%"><?php echo $lg_description;?></td>
    <td id="mytabletitle" style="border-left:none;" width="10%"><?php echo $lg_book;?></td>
    <td id="mytabletitle" style="border-left:none;" width="5%" align="center"><?php echo "Halaman ";?></td>
  </tr>


<?php 
	$q=0;
	$sql="select * from hwork where uid='$username' and cls='$cls' and sub='$sub' and year='$year' $sqlsort";
	$res=mysql_query($sql)or die("query failed:".mysql_error());
	while($row=mysql_fetch_assoc($res)){
		$id=$row['id'];
		$dt=$row['dt'];
...
?>
  <tr bgcolor="<?php echo $bg;?>" style="cursor:default" onMouseOver="this.bgColor='#CCCCFF';" onMouseOut="this.bgColor='<?php echo $bg?>';">
        ...
        <td id="myborder" style="border-left:none; border-top:none;" align="center"><?php echo "$due";?></td>
        <td id="myborder" style="border-left:none; border-top:none;">
        	<a href="../hwork/hwork_reg.php?xid=<?php echo $id;?>"><img src="../img/edit12.png"> <?php echo "$type";?></a></td>
        <td id="myborder" style="border-left:none; border-top:none;"><?php echo "$des";?></td>
        <td id="myborder" style="border-left:none; border-top:none;"><?php echo "$book";?></td>
        <td id="myborder" style="border-left:none; border-top:none;" align="center"><?php echo "$ms";?></td>
