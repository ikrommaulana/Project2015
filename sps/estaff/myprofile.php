    ...
    <form action="" method="post" enctype="multipart/form-data" name="myform">
		...
		<div id="mymenu" align="center">
				<?php if($uid!=""){?>
                                ...
                                <a href="#" onClick="process_form('update')"id="mymenuitem"><img src="<?php echo $MYLIB;?>/img/save.png"><br><?php echo $lg_update;?></a>
				<? }else {?>
				...
				<?php }?>
						...
						<div id="mymenu_space">&nbsp;&nbsp;</div>
                                <a href="myprofile.php?uid=<?php echo $uid;?>" id="mymenuitem"><img src="<?php echo $MYLIB;?>/img/reload.png"><br><?php echo $lg_refresh;?></a>
						<div id="mymenu_space">&nbsp;&nbsp;</div>
						<div id="mymenu_seperator"></div>
						<div id="mymenu_space">&nbsp;&nbsp;</div>
    ...
    <div id='jqxWidget'>
        ...
        <div id='jqxTabs'>
            <ul>
                ...
                <li title="Password">Perbaruan Password</li>
            ...
            <div>
            	...
            	<table width="100%" cellpadding="2px" cellspacing="2px">
                    ...
                    <tr>
                    	<td>LEVEL SISTEM</td>
                        <td>:</td>
                        <td><input type="text" name="syslevel" value="<?php echo $syslevel;?>" readonly></td>
                    </tr>
                    <tr>
                    	<td>STATUS</td>
                        <td>:</td>
                        <td>
			<?php if($status=="0"){$sta="ACTIVE";}else if($status=="1"){$sta="TERMINATE";}else{$sta="RESIGN";}
			echo $sta;?>
                        </td>
                    </tr>
                     <tr>
                    	<td>NO INDUK</td>
                        <td>:</td>
                        <td><input readonly type="text" name="sid" value="<?php echo $sid;?>"</td>
                    </tr>
                </table>
            ...
            <!---------------------------form6------------------------>
            <div>
            	<div id="mytabletitle">Perbaharui Password </div>
           ...
           <table width="50%">
			...
			<input type="hidden" name="xplain1" value="<?php echo $xplain1;?>">
			<input type="hidden" name="xplain2" value="<?php echo $xplain2;?>">
			<input type="hidden" name="xplain3" value="<?php echo $xplain3;?>">
			<input type="hidden" name="xplain4" value="<?php echo $xplain4;?>">
			<input type="hidden" name="xplain5" value="<?php echo $xplain5;?>">
			<input type="hidden" name="reason" value="<?php echo $reason;?>">
			<input type="hidden" name="effect" value="<?php echo $effect;?>">
