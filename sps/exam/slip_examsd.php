...
for($numberofstudent=0;$numberofstudent<count($stu);$numberofstudent++){
		...
		$sqltname="select * from ses_cls where cls_code='$ccode' and year='$year' and sch_id='$sid'";
		...
		$sqlkepalasekolah="select * from usr where job='Kepala Sekolah' and sch_id='2'";
 ...
 <?php } ?>
	...
	<table width="100%" >
      ...
      <tr>
	   ...
	   <tr>
        <td><?php echo "ALAMAT SEKOLAH";?></td>
        <td>:</td>
        <td><?php echo strtoupper("$addr $state");?></td>
      </tr>
    </table>
	</td>
    <td width="50%" valign="top">
...
<table width="100%" border="0">
  <tr>
   ...
   <?php
		...
		echo "<td id=\"myborder\" width=\"5%\" rowspan=\"2\" align=\"center\">A.</td>";
        ...
        while($row3=mysql_fetch_assoc($res3)){
			...
			$contype=$row3['val'];
			$conview=$row3['etc'];
			//$sql4="select * from exam where stu_uid='$uid' and year='$year' and examtype='$exam' order by sub_code asc";
			...
			while($row4=mysql_fetch_assoc($res4)){
				...
				if($subno==1){
				echo "<tr id=mytitlebg style=font-size:100%>";
				echo "<td id=\"myborder\" width=\"5%\"align=\"center\">B.</td>";
				echo "<td id=\"myborder\" width=\"30%\">&nbsp;$contruct</td>";
				echo "<td id=\"myborder\" width=\"5%\" align=\"center\">&nbsp;</td>";
				echo "<td id=\"myborder\" width=\"20%\" colspan=\"2\" align=center></td>";
				echo "<td id=\"myborder\" width=\"40%\" align=center></td>";
				echo "</tr>";
				}
...
<td id="myborder" width="5%" align="center">&nbsp;C.</td>
...
<?php if($CONFIG['SHOW_CTT_GURU']['val']){?>
	...
	<tr><td height="50" valign="top"><?php echo $mm;?>
	</td></tr>
...
<? if ($exam=="PS2" && $clslevel != 6){
	
?>
<table>
	<td id="myborder" align="left"> <table><tr><td><B>Keputusan :</B> Naik / Tinggal Di Kelas : ......................................... </td></tr></table>    
...
?>
<table>
	<td id="myborder" align="left"> <table><tr><td><B>Keputusan :</B> Tamat / Belum Tamat Belajar : ......................................... </td></tr></table>    
...
?>
	...
	<table align="right">
	<tr>
	<td id="myborder" align="left"style="padding-right:200px;padding-left:150px; "> Dikeluarkan di  <?  echo  $daerah ." Pada ".date("d/m/Y") ?> </td>    
...
<?php if($CONFIG['SHOW_SIGNING']['val']){?>
	...
	<?php }
	if ($exam=="PS2") {
	if($CONFIG['SHOW_TT_PENGETUA']['val']){?>
