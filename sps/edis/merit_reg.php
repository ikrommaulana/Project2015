...
if($op=="save"){
	...
	if($id!=""){
		...
		$sql="insert into dis(dt,sch_id,year,stu_uid,cls_code,cls_level,dis,des,act,rep,val,cls_name,stu_name,adm,ts,cat) values (now(),$schid,'$year','$uid','$clscode',$clslvl,'$kes','$des','$actlist','$rep',$v,'$clsname','$name','$adm',now(),'merit')";
...
function process_form(action,id){
	...
	if(action=='save'){
		...
		if(document.myform.kes.value==""){
			alert("Please enter student merit..");
 ...
 <td width="100%" valign="top">
 	<table width="100%"  border="0" cellpadding="0" >
	  <tr>
		...
		<a href="#" onClick="newwindow('dis_case_list.php?cs=merit',0)"><img src="../img/edit12.png"><?php echo "PRESTASI";?>&gt;&gt;</a><br>
 	  	<textarea name="kes" rows="2" style="width:95% " readonly><?php echo "$xdis";?></textarea>
		</td>
	  </tr>
	  <tr>
		<td width="50%">
			<div id="mytitle"><?php echo "LAPORAN PRESTASI";?></div>
