...
<input type="hidden" name="p" value="../efee/fee_projection">
...
while($rows=mysql_fetch_assoc($ress)){
        ...
        while($row=mysql_fetch_assoc($res)){
			...
			$feelain=0;
			$feelaindes="";
			$sql="select * from feepay where tid=$fid and fee='$lg_other'";
			$resxx=mysql_query($sql)or die("$sql failed:".mysql_error());
			if($rowxx=mysql_fetch_assoc($resxx)){
					$feelain=$rowxx['rm'];
...
<table width="100%" class="print_font" cellspacing="0" style="font-size:9px ">
	<tr>
		<td id="mytabletitle" width="1%" align="center" rowspan="2"><?php echo strtoupper($lg_no);?></td>
...
?>
			<td id="myborder" bgcolor="#FAFAFA" align=right><?php if($sumpaytype[$jj]['TUNAI']==0) echo "-"; else echo number_format($sumpaytype[$jj]['TUNAI'],2,'.',',');?></td>
<?php } ?>
...
?>
			<td id="myborder" bgcolor="#FAFAFA" align=right><?php if($sumpaytype[$jj]['CEK']==0) echo "-"; else echo number_format($sumpaytype[$jj]['CEK'],2,'.',',');?></td>
<?php } ?>
		<td id="myborder" bgcolor="#FAFAFA" align="right" style="font-weight:bold"><?php echo number_format($total,2,'.',',');?></td>
	</tr>
	<tr>
...
?>
			<td id="myborder" bgcolor="#FAFAFA" align=right><?php if($sumpaytype[$jj]['K.Kredit']==0) echo "-"; else number_format($sumpaytype[$jj]['K.Kredit'],2,'.',',');?></td>
<?php } ?>
		<td id="myborder" bgcolor="#FAFAFA" align="right" style="font-weight:bold"><?php echo number_format($total,2,'.',',');?></td>
	</tr>
	<tr>
...
?>
			<td id="myborder" bgcolor="#FAFAFA" align=right><?php if($sumpaytype[$jj]['Online']==0) echo "-"; else echo number_format($sumpaytype[$jj]['Online'],2,'.',',');?></td>
<?php } ?>
		<td id="myborder" bgcolor="#FAFAFA" align="right" style="font-weight:bold"><?php echo number_format($total,2,'.',',');?></td>
	</tr>
	<tr>
...
?>
			<td id="myborder" bgcolor="#FAFAFA" align=right><?php if($sumpaytype[$jj]['DLL']==0) echo "-"; else echo number_format($sumpaytype[$jj]['DLL'],2,'.',',');?></td>
<?php } ?>
		<td id="myborder" bgcolor="#FAFAFA" align="right" style="font-weight:bold"><?php echo number_format($total,2,'.',',');?></td>
	</tr>
	<tr>
