...
<div id="story">
 ...
 <?php
	...
	mysql_free_result($res);
?>
<div id="mytitlebg" align="center">RESI SEMENTARA</div>
     ...
     <td><table width="100%">
       <tr>
         <td width="65%"><table width="100%" id="mytable">
             <tr>
               <td width="26%" valign="top"><?php echo strtoupper("Nama Sekolah"); ?></td>
             ...
             <tr>
               <td valign="top">NO KTP ORANG TUA</td>
               <td valign="top">:</td>
         ...
         <td width="35%" valign="top"><table width="100%" id="mytable">
             <tr>
               <td width="45%" valign="top">NO. RESI</td>
               <td width="1%" valign="top">:</td>
          ...
          <table width="100%"  id="mytabletitle">
            <tr >
              <td width="10%">NO</td>
              <td width="60%">KETERANGAN PEMBAYARAN</td>
...
<table width="100%" id="mytabletitle">
  		<tr>
              <td width="10%">&nbsp;</td>
              <td width="60%">JUMLAH PEMBAYARAN</td>
