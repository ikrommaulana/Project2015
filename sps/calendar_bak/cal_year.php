...
if (($taqwim!="")) {
				...
				for ($i=0; $i<count($cal); $i++) {
					$dt=$cal[$i];
					$sql="delete from ses_cal where year='$year' and d='$dt' and sch_id=$sid";
					$res=mysql_query($sql)or die("query failed:".mysql_error());
					if($op>0){
						$sql="insert into ses_cal(year,d,sta,sch_id) values ('$year','$dt',$op,$sid)";
						$res=mysql_query($sql)or die("query failed:".mysql_error());
					}
				}
}
      ...
      <tr>
              ...
              <td align=center background="<?php echo $MYLIB;?>/img/bg_title.jpg">
                <a href="#" onClick="popup_show('popup', 'popup_drag', 'popup_exit', 'screen-center',0,0);">
              		<font size='4' face='Comic Sans MS' color="#FFFFFF"><?php echo "Calendar $sname $year";?>
		...
		<td width="25%" valign="top" id="myborder" style="border-left:none; border-color:#96C;">
            ...
            <tr>
              	...
              	<td colspan=7 height="20px" align=center background="<?php echo $MYLIB;?>/img/bg_title_dark2.jpg">
              		<font size='2' face='Comic Sans MS' color="#FFFFFF"><?php echo "$mn";?>
            	</td>
              
        	</tr>
            <tr>
              <td align=center height="20px" width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="2">Sun</font></b></td>
              <td align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="2">Mon</font></b></td>
              <td align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="2">Tue</font></b></td>
              <td align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="2">Wed</font></b></td>
              <td align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="2">Thu</font></b></td>
              <td align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="2">Fri</font></b></td>
              <td align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="2">Sat</font></b></td>
        </tr><tr>
<?php
