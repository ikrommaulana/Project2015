...
<table width="100%" cellspacing="0">
  <tr>
	...
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=TOV";?>"><img src="../img/edit12.png" class="printhidden">TOV</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=OTR1";?>"><img src="../img/edit12.png" class="printhidden">OTR1</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=AR1";?>"><img src="../img/edit12.png" class="printhidden">AR1</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=OTR2";?>"><img src="../img/edit12.png" class="printhidden">OTR2</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=AR2";?>"><img src="../img/edit12.png" class="printhidden">AR2</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=OTR3";?>"><img src="../img/edit12.png" class="printhidden">OTR3</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=AR3";?>"><img src="../img/edit12.png" class="printhidden">AR3</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=ETR";?>"><img src="../img/edit12.png" class="printhidden">ETR</a></td>
	<td id="mytabletitle" width="4%" align="center" colspan="2"><a href="p.php?p=../ehc/hc_sub_stu<?php echo "&sid=$sid&clscode=$clscode&subcode=$subcode&gid=$gid&isprint=$isprint&exam=AR4";?>"><img src="../img/edit12.png" class="printhidden">AR4</a></td>
  </tr>
  <tr>
...
<?php 
if($clscode!=""){
	$sql="select stu.name,stu.uid,stu.sex,ses_stu.cls_name from stu INNER JOIN ses_stu ON stu.uid=ses_stu.stu_uid where ses_stu.sch_id=$sid and year='$year' $sqlclscode $sqlstatus $sqlsort";
	$res=mysql_query($sql)or die("$sql:query failed:".mysql_error());
  	while($row=mysql_fetch_assoc($res)){
		$uid=$row['uid'];
...
<?php for($j=0;$j<$i;$j++){ ?>
    <td id="myborder"  colspan="2" align="center"><?php printf("%.02f", $xgp[$j]);?></td>
<?php }?>
</tr>
<!-- 
<tr>
