...
<table width="100%" id="mytitlegb">
  <tr>
    <td width="100%" align="left"><?php echo strtoupper($lg_cocurriculum);?> <?php echo $f;?></td>
  </tr>
</table>
<table width="100%" >
  <tr>
...
<table width="100%">
  <tr>
    <td id="mytabletitle" width="3%"><?php echo strtoupper($lg_code);?></td>
    <td id="mytabletitle" width="30%"><?php echo strtoupper($lg_activity);?></td>
    <td id="mytabletitle" width="10%"><?php echo strtoupper($lg_year);?></td>
    <td id="mytabletitle" width="30%"><?php echo strtoupper($lg_position);?></td>
  </tr>
<?php
