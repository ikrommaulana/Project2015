...
?>
	<tr bgcolor="<?php echo $bg;?>" style="cursor:default" onMouseOver="this.bgColor='#CCCCFF';" onMouseOut="this.bgColor='<?php echo $bg?>';">
		...
		<td id=myborder><a href="../ekoq/koq_stu_reg.php?<?php echo "uid=$uid&sid=$sid";?>" target="_blank" title="KO-Q <?php echo addslashes($name);?>" onClick="return GB_showPage('Ko-Q : <?php echo addslashes($name);?>',this.href)"><?php echo "$name";?></a></td>
