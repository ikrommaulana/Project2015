...
<div id="mypanel">
	...
	<div id="mymenu_seperator"></div>
	<div id="mymenu_space">&nbsp;&nbsp;</div>
		<a style="cursor:pointer" onClick="<?php if($f!=""){?>top.document.myform.submit();<?php }?>window.close();parent.$.fancybox.close();parent.parent.GB_hide();" id="mymenuitem">
...
<div id="mytitlebg">NEWS SETTING <?php echo $f;?></div>
<table width="100%">
	<tr id="mytitle">
