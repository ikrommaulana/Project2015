...
<table width="100%" border="0" style="margin-left:-20px">
	...
	<tr>
        ...
        <?php 
						if($login=="0"){
							if($LG=="BM") 
								echo "Maaf. KP tidak dijumpai"; 
							else 
								echo "Sorry. IC number not found.";
						}
		...
		?>
        					...
        					<select name="sid" class="form-login">
                              <?php	
							  	if($sid=="")
									echo "<option value=\"\">- $lg_select $lg_program -</option>";
								else
                            ...
                            <?php echo $lg_ic_number;?><br>
							<input name="username" type="text" class="form-login">
                            <br>
                            <?php echo $lg_password;?><br>
                            <input name="password" type="password" class="form-login">
                            <input type="button" name="button" style="height:41px;" value="<?php echo $lg_enter;?>" onClick="process_form()">
                            <br>
