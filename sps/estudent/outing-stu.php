...
<div id="mymenu" align="center">
	<a href="outing-app.php" rel="gb_page_center[1000, 480]" target="_blank" id="mymenuitem"><img src="../img/new.png"><br>Outing Application</a>
...
?>
             <td id="myborder">
			  	<a href="outing-app.php?id=<?php echo $id;?>" <?php if(!$confirm){?>style="text-decoration:line-through "<?php } ?> title="Edit" rel="gb_page_center[800, 480]" target="_blank"">
