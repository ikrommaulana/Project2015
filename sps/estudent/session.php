...
function process_login()
{
	...
	$sql="select * from stu where sch_id=$sid and (p1ic='$user' or p2ic='$user') and status=6";
	...
	if(mysql_num_rows($res)>0){
		...
		$sql="update stu set plogin=now() where sch_id=$sid and (p1ic='$user' or p2ic='$user') and status=6";
