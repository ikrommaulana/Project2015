...
<table width="100%" id="mytable" >
  <tr>
	<!--<td id="mytabletitle" width="2%" align="center"><input type=checkbox name=checkall value="0" onClick="check(1)"></td>-->
	<td id="mytabletitle" width="3%" align="center"><?php echo strtoupper($lg_no);?></td>
	<td id="mytabletitle" width="8%" align="center"><?php echo strtoupper($lg_date);?></td>
	...
	<td id="mytabletitle" width="%" align="center"><?php echo $lg_description;?></td>
	<td id="mytabletitle" width="6%" align="center"><?php echo strtoupper($lg_book);?></td>
	<td id="mytabletitle" width="5%" align="center"><?php echo strtoupper("halaman");?></td>
	<td id="mytabletitle" width="5%" align="center"><?php echo strtoupper('nilai');?></td>
	<td id="mytabletitle" width="10%" align="center"><?php echo strtoupper($lg_status);?></td>
	<td id="mytabletitle" width="7%" align="center"><?php echo "TANGGAL DI KUMPULKAN";?></td>
	<td id="mytabletitle" width="5%" align="center"><?php echo "ATTACHMENT";?></td>
  </tr>
...
<?php 
	...
	while($row=mysql_fetch_assoc($res)){
		...
		$sqlhwork="select * from hwork where sid='$schid' and dt like '$year%' and id='$ref_id'";
...
?>
  ...
  <tr <?php echo "$bgc";?>>
	<!--<td align="center"><input id="checker" type="checkbox" name="checker[]" value="<?php echo "$xid";?>" onClick="check(0)"></td>-->
    ...
    <td id="myborder" align="center"><?php echo "$submitdt";?></td>
    <td id="myborder"><a href="<?php echo "$dir_file$xfile"; ?>"><?php echo $filelink; ?></a></td>
  </tr>
