...
<table width="100%" border="0" >
	...
	<tr>
        <td align="center"><H2>Parent&nbsp;Online</H2></td>
     </tr>
</table>
        <font color="#FF9900" style="font-weight:bold">
        <?php 
						if($login=="0"){
							echo "Data yang Anda masukkan tidak sesuai, silahkan ulangi kembali<br>"; 
	...
	<table>
		...
		<tr>
			<td>
				<input name="uid" type="text" class="form-login" placeholder="Username">
			</td>
		</tr>
		<tr>
			<td>
				<input name="username" type="password" class="form-login" placeholder="Password"> <input type="button" name="button" style="height:41px;" value="<?php echo $lg_enter;?>" onClick="process_form()">
			</td>
		</tr>
	</table>								
         <!--          
