...
<table width="100%" id="mytable" >
  <tr>
	...
	<!--<td id="mytabletitle" width="5%" align="center"><?php echo "TANGGAL DIKUMPULKAN";?></td>-->
  </tr>
...
?>
  ...
  <tr <?php echo "$bgc";?>>
	...
	<td id="myborder">&nbsp;<a href="#" onClick="process_form('edit',<?php echo "$xid";?>)"><?php echo "$sname_hwork";?></a></td>
