...
$isforen2=$_REQUEST['isforen2'];
$isforen3=$_REQUEST['isforen3'];
if($sid=="")
	$sid=$_SESSION['sid'];
...
?>
                ...
                <tr>
                  <td>*<?php echo "NIS";?></td>
				  <td>:</td>
                  <td><input name="uid" type="text" id="uid" value="<?php echo $uid;?>"><font color =red><b>** NOMOR NIS TIDAK BOLEH SAMA ANTARA SISWA ** </b></font></td>
                </tr>
		<tr>
                  <td><?php echo "NISN";?></td>
				  <td>:</td>
                  <td><input name="nisn" type="text" id="nisn" value="<?php echo $nisn;?>" <?php if($nisn!="") echo "readonly"?> ></td>
                </tr>
                <tr>
                  <td><?php echo "Tahun Ajaran ";?></td>
				  <td >:</td>
                  <td ><!--<input name="intake" type="text" value="<?php echo $intake;?>">-->
		       <select name="intake">
						<?php
								if($intake!="")
								...
								$sql="select * from type where grp='session' and prm!='$intake' order by val desc";
								$res=mysql_query($sql)or die("query failed:".mysql_error());
								while($row=mysql_fetch_assoc($res)){
											$s=$row['prm'];
...
?>
				...
				<tr>
                  <td><?php echo $lg_endreason;?></td>
				  <td>:</td>
                  <td><input name="reason" type="text" id="reason" size="48" value="<?php echo $reason;?>"></td>
                </tr>
				<tr>
                  <td><?php echo $lg_other_information;?></td>
				  <td>:</td>
                  <td><input name="etc" type="text" id="etc" size="48" value="<?php echo $etc;?>"></td>
                </tr>
				...
				<table width="100%">
					  ...
					  <tr>
						...
						<td id="myborder" width="25%"><input name="isasuh" type="checkbox" id="isasuh" value="1" <?php if($isasuh) echo "checked"?> ><?php echo "Anak Asuh";?></td>
					  ...
					  <tr>
						<td width="15%" id="myborder"  bgcolor="#FAFAFA">
					  ...
					  <tr>
						<td ><input type="file" name="file" size="5"></td>
						<td ><input type="file" name="img" size="5"></td>
					  </tr>
					  <tr>
						<td colspan="2">Image Not More Then 100k. Please resize.</td>
					  </tr>
	...
	<td width="50%" id="myborder" valign="top">
			  ...
			  <table width="100%" >
                <tr>
					  ...
					  <td><input name="namapelajar" type="text" value="<?php echo stripslashes($namapelajar);?>" size="50"></td>
		</tr>
		<tr>
			<td><?php echo "No Akta Lahir";?></td>
			<td><input name="ic" type="text" id="ic" value="<?php echo $ic;?>"><font color="#0000FF" size="1"> (<?php echo $lg_no_space_and_dash;?>)</font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><select name="day" id="day">
							...
							<?php	
								...
								while($row=mysql_fetch_assoc($res)){
											$s=$row['name'];
											if($s==$citizen){$selected="selected";}else{$selected="";}
		...
		<tr>
			...
			<td><?php if ($isforen3!='1')
						...
						<?php	
							if($state=="")
								echo "<option value=\"\">- Tempat Lahir -</option>";
							else
								echo "<option value=\"$bstate\">$bstate</option>";
							//$sql="select * from state where name!='$state' order by name";
                            $sql="select * from daerah where state!='$state' order by name asc";
							$res=mysql_query($sql)or die("query failed:".mysql_error());
							while($row=mysql_fetch_assoc($res)){
										$s=$row['name'];
										echo "<option value=\"$s\">$s</option>";
					...
					<label style="cursor:pointer;">
						<input type="checkbox" name="isforen3" value="1" 
						onClick="document.myform.submit();
						if(document.myform.isforen3.checked)document.myform.bstate.value='';else document.myform.bstate.value='';"
						<?php if($isforen3) echo "checked";?>> 
						Tempat Lain
			                </label> </td>
		</tr>
				<tr>
			 ...
			 <table width="100%" >
				...
				<tr>
				  ...
				  <tr>
					   ...
					   <tr>
                  <td id="myborder" ><?php echo "Telepon Rumah"?></td>
...
<table width="100%">
			...
			<tr>
					...
					<input name="p1wn" type="text" id="p1wn" value="<?php echo $p1wn;?>">
					<?php }?>
					<label style="cursor:pointer;">
						<input type="checkbox" name="isforen1" value="1" 
						onClick="document.myform.submit();
						if(document.myform.isforen1.checked)document.myform.p1wn.value='';else document.myform.p1wn.value='';"
            ...
            <tr>
					<td id="myborder"><?php echo "Telepon Kantor";?></td>
			...
			<tr>
					<td id="myborder"><?php echo $lg_salary;?> (Rp)</td>
...
<table width="100%" >
            ...
            <tr>
					...
					<input name="p2wn" type="text" id="p2wn" value="<?php echo $p2wn;?>">
					<?php }?>
					<label style="cursor:pointer;">
						<input type="checkbox" name="isforen2" value="1" 
						onClick="document.myform.submit();
						if(document.myform.isforen2.checked)document.myform.p2wn.value='';else document.myform.p2wn.value='';"
						<?php if($isforen2) echo "checked";?>> 
						Tempat Lain
			                </label>
