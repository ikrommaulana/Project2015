...
<?php	
	...
	//echo $sql;
  	while($row=mysql_fetch_assoc($res)){
		...
		$sql="select * from stu where id='$id' and sch_id=$sid";
...
<?php
		...
		echo "<td class=myborder style=\"border-right:none; border-top:none;\" align=center>$year</td>";
