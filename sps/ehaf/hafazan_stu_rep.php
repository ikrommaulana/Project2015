...
<table width="100%" id="mytitle">
  <tr>
    <td width="100%" align="left">HAFALAN - <?php echo strtoupper($sname);?></td>
  </tr>
</table>
...
<?php } ?>
	...
	<table width="100%" >
      ...
      <tr>
        <td>NO. Akte Lahir/ Passport Siswa </td>
        <td>:</td>
        <td><?php echo "$xic";?> </td>
      </tr>
	  <tr>
...
<table width="100%">
	<tr>
		<td width="3%" id="mytabletitle">Juzz&nbsp;1</td>
...
<?php 
	if($i%20==0){
		echo"</tr><tr>";
		$k++;
		echo "<td width=\"3%\" id=\"mytabletitle\">Juzz&nbsp;$k</td>";
	}
} 
?>
