...
-->
	...
	<draw>
		...
		<text layer='background' shadow='high' color='FFFFFF' alpha='90' size='15' x='0' y='0' width='400' height='150'><?php echo $gtnote;?></text>
      	<text color='FFFFFF' alpha='50' rotation='-90' size='20' x='1' y='270' width='300' height='200' h_align='center'><?php echo $gynote;?></text>
		<text color='000000' alpha='70' rotation='0' size='8' x='50' y='240' width='300' height='200' h_align='center'><?php echo $gxnote;?></text>
		<text color='666666' alpha='40' rotation='0' size='40' y='80' width='400' height='400' h_align='center' ><?php echo $gcnote;?></text>
