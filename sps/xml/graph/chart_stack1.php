...
for($j=0;$j<count($xxval);$j++){
	$xxxval=explode(",",$xxval[$j]);
		...
		for($i=1;$i<count($xxxval);$i++){
			$tooltips=abs($xxxval[$i]);
			echo "<number line_color='FFFFFF' line_thickness='1' line_alpha='65' tooltip='$tooltips%' >$xxxval[$i]</number>\n";
		} 
		echo "</row>";
} 
?>
...
-->
	...
	<draw>
		...
		<text layer='background' shadow='high' color='FFFFFF' alpha='90' size='16' x='0' y='0' width='400' height='150'><?php echo $gtnote;?></text>
		...
		<text color='333333' alpha='50' rotation='0' size='40' y='80' width='400' height='400' h_align='center' ><?php echo $gcnote;?></text>
   ...
   <axis_category skip='0' size='8' color='FFFFFF' alpha='90' orientation='diagonal_down' />
   ...
   <chart_transition type='slide_up' delay='2' duration='1' order='series' />
