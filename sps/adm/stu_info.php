...
<div id="mytabdiv" style="font-size:12px; margin:0px 0px 0px 0px;">
	...
	<div id="tab5" style="background-color:#DDDDDD; margin:0px 0px 0px 0px;<?php if($p=="../ehaf/hafazan_stu_rep") echo "background:#CCCCFF;";?>" class="mytab"><a href="stu_info.php?p=../ehaf/hafazan_stu_rep&uid=<?php echo $uid?>&sid=<?php echo $sid?>">Hafazan</a></div>
