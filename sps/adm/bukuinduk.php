...
<?php
		...
		echo "<td class=myborder style=\"border-right:none; border-top:none;\" align=\"center\">$sex</td>";
 		echo "<td class=myborder style=\"border-right:none; border-top:none;\"><a href=\"../edaftar/bukuinduk.php?sid=$sid&ic=$ic&uid=$uid\" title=Profile target=_blank>$name</a></td>";
