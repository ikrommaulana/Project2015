...
<div id="mytitle">
	...
	<table width="100%" cellspacing="0">
      <tr>
		...
		<td id="mytabletitle" width="20%"><a href="#" onClick="formsort('prm','<?php echo "$nextdirection";?>')" title="sort">COMPANY NAME</a></td>
		<td id="mytabletitle" width="5%" align="center"><a href="#" onClick="formsort('val','<?php echo "$nextdirection";?>')" title="sort">STATUS</a></td>
		<td id="mytabletitle" width="10%" align="center"><a href="#" onClick="formsort('code','<?php echo "$nextdirection";?>')" title="sort">COMPANY NO.</a></td>
		<td id="mytabletitle" width="20%"><a href="#" onClick="formsort('etc','<?php echo "$nextdirection";?>')" title="sort">CONTACT</a></td>
		<td id="mytabletitle" width="45%"><a href="#" onClick="formsort('des','<?php echo "$nextdirection";?>')" title="sort">ADDRESS</a></td>
      </tr>
<?php
