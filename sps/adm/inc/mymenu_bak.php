...
<table width="90" height="90" style="font-size:9px; background-color:#CCCCFF ">
 ...
 <table width="100%" style="font-size:9px " cellspacing="0">
       ...
       <tr>
	    ...
	    <tr>
         <td valign="top"><?php echo $lg_access;?></td>
		 <td valign="top">:</td>
...
<div style="font-size:11px; font-weight:bold; color:#666666; border-bottom:1px solid #F1F1F1;padding-top:3px"><?php echo $lg_personal;?></div>
<div id="sectionLinks">
...
<?php if((ISACCESS("cctv",0))&&($ON_CCTV)){	?>
