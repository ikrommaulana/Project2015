...
<form name="myform" method="post" enctype="multipart/form-data">
	<input type="hidden" name="p" value="stu_csv_upload">
...
<a href="#" onClick="javascript:href='p.php?p=stu_csv_upload'" id="mymenuitem"><img src="../img/new.png"><br>New</a>
</div> <!-- end mymenu -->
	...
	if($fn!=""){
		...
		/*
			list($name,$ic,$sex,$bday,$bplace,$childno,$siblingno,
				...
				$add,$tel)=explode("\t",$str);
		*/
			list($rdate,$name,$ic,$sex,$race,$religion,$bday,$ill,$tel,$tel2,$fax,$hp,$email,$addr,$state,
			...
			//else{
				...
				if(strcasecmp($sex,"Lelaki")==0)
					$sex="LELAKI";
				**/
				$sql="insert into stu(cdate,sch_id,rdate,name,ic,sex,race,religion,bday,ill,tel,tel2,fax,hp,mel,addr,state,p1name,p1ic,p1rel,p1job,p1sal,p1com,p1addr,p1state,p1tel,p1tel2,p1fax,p1hp,p1mel,p2name,p2ic,p2rel,p2job,p2sal,p2com,p2addr,p2state,p2tel,p2tel2,p2fax,p2hp,p2mel,citizen,bandar,poskod,p1race,p2race,p1wn,p2wn,p1salx,p2salx,p1age,p2age,birthplace,nick,p1edu,p2edu,p3name,p3ic,p3hp,p3tel,p3tel2,p3mel,p3add,p3rel,p3fax,p3addr,sponser,bstate,intake,pschool,sttb,stopdate,yearinschool,ussbn,uan,reasonleaving,pschool2,sttb2,stopdate2,yearinschool2,bahasa,anakke,jumkandung,jumtiri,jumangkat,tinggalbersama,yatim,jaraksekolah,nobukuinduk,status)values
				(now(),$sid,$rdate,'$name','$ic','$sex','$race','$religion','$bday','$ill','$tel','$tel2','$fax'
