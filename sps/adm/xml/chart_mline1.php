...
?>
	...
	<chart_guide horizontal='true' thickness='1' color='000000' alpha='50' type='dashed' radius='3' line_color='000000' line_alpha='75' line_thickness='1' text_color='000000' text_h_alpha='90' />	
	...
	<chart_rect x='80' y='40' width='300' height='150' positive_color='eeeeff' positive_alpha='30' bevel='bg' />


<!-- 
	<chart_pref line_thickness='1' point_shape='circle' fill_shape='false' />
...
-->
	...
	<draw>
      	...
      	<text shadow='high' color='666666' alpha='50' rotation='-90' size='30' x='5' y='270' width='300' height='200' h_align='center'><?php echo $gynote;?></text>
		...
		<text shadow='shadow1' color='666666' alpha='40' rotation='0' size='40' x='120' y='60' width='400' height='400' h_align='left'><?php echo $gcnote;?></text>
