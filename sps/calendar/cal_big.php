...
$m_ind = Array (1=>"Januari", 2=>"Pebruari", 3=>"Maret", 4=>"April",
...
<table width="100%" cellspacing="0">
		...
		<tr>
              <td id="myborder" style="border-right:none;" align=center height="30px" width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="3">Ahad</font></b></td>
              <td id="myborder" style="border-right:none;" align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="3">Senin</font></b></td>
              <td id="myborder" style="border-right:none;" align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="3">Selasa</font></b></td>
              <td id="myborder" style="border-right:none;" align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="3">Rabu</font></b></td>
              <td id="myborder" style="border-right:none;" align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="3">Kamis</font></b></td>
              <td id="myborder" style="border-right:none;" align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="3">Jum'at</font></b></td>
              <td id="myborder" style="border-right:none;" align=center width="14%" background="<?php echo $MYLIB;?>/img/bg_title_lite.jpg"><b><font face="Comic Sans MS" size="3">Sabtu</font></b></td>
		</tr>
		<tr>
        <?php
