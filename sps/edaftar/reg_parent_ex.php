...
<table width="100%" cellspacing="0"  style=" background-color:#FFF;">
  <tr><td width="50%" id="myborder"  style="border-right:none; ">
		<div id="mytitlebg" style="background-color:#FFFF00">C. <?php echo strtoupper($lg_father_information);?></div>
...
<?php } ?>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			 ...
			 <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              ...
              <td><input name="p1sal" type="text" id="p1sal" value="<?php echo $p1sal;?>" size="12" maxlength="10" onKeyUp="chkno(this);"></td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			...
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
				...
				<td><input name="p1hp" type="text" id="p1hp" value="<?php echo $p1hp;?>" size="14" maxlength="10" onKeyUp="chkno(this);">
				(<?php echo $lg_no_space_and_dash;?>)</td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
				<td id="myborder" style="border-top:none;border-left:none;border-right:none;">
					<?php echo $lg_tel_home;?>
				<td><input name="p1tel" type="text" id="p1tel" value="<?php echo $p1tel;?>" size="14" maxlength="10" onKeyUp="chkno(this);"></td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
                ...
                <?php echo $lg_fax;?>: <input name="p1fax" type="text" id="p1fax" value="<?php echo $p1fax;?>" size="14" maxlength="10" onKeyUp="chkno(this);">
                </td>
            </tr>
            
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
					<td id="myborder" style="border-top:none;border-left:none;border-right:none;"><?php echo $lg_email;?><td>
                    	<input name="p1mel" type="text" id="p1mel" value="<?php echo $p1mel;?>" size="38"><br>
                        Eg. mel@yahoo.com
					</td>
  			</tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
                		<td id="myborder" width="20%"style="border-top:none;border-left:none;border-right:none;">Gambar</td>
                       	<td><input type="file" name="p1pic">(Tidak melebihi 100KB)</td>
          </tr>
</table>
    ...
    <td width="50%" id="myborder" >
		...
		<div id="mytitlebg" style="background-color:#FFFF00 ">D. <?php echo strtoupper($lg_mother_information);?></div>
        <table width="100%" id="mytitle" style="font-size:10px;">
          	<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
				<td id="myborder" style="border-top:none;border-left:none;border-right:none;">
					<?php echo $lg_name;?>*</td>
            	<td width="70%" ><input name="p2name" type="text" id="p1name" value="<?php echo $p2name;?>" size="38"></td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
				<td id="myborder" style="border-top:none;border-left:none;border-right:none;">
					<?php echo $lg_ic;?>*</td>
              	<td><input name="p2ic" type="text" id="p2ic" value="<?php echo $p2ic;?>" size="12"  maxlength="12" onKeyUp="chkno(this);"></td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              ...
              <a style="cursor:pointer" onClick="document.myform.p2sal.value=0;document.myform.p2job.value='<?php echo $lg_house_wife;?>';"><?php echo $lg_house_wife;?> (<?php echo $lg_click;?>)</a>
			  </td>
            </tr>
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			  <td id="myborder" style="border-top:none;border-left:none;border-right:none;"><?php echo $lg_salary;?>* (<?php echo strtoupper($lg_rm);?>)</td>
              <td><input name="p2sal" type="text" id="p2sal" value="<?php echo $p2sal;?>" size="12" maxlength="10" onKeyUp="chkno(this);"></td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			  <td id="myborder" style="border-top:none;border-left:none;border-right:none;">Pendidikan Tertinggi</td>
			...
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              ...
              <td> <input name="p2hp" type="text" id="p2hp" value="<?php echo $p2hp;?>" size="14" maxlength="10" onKeyUp="chkno(this);">
			  (<?php echo $lg_no_space_and_dash;?>)</td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			  <td id="myborder" style="border-top:none;border-left:none;border-right:none;">
					<?php echo $lg_tel_home;?></td>
              <td><input name="p2tel" type="text" id="p2tel" value="<?php echo $p2tel;?>" size="14" maxlength="10" onKeyUp="chkno(this);"></td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			  <td id="myborder" style="border-top:none;border-left:none;border-right:none;">
              ...
              <td><input name="p2tel2" type="text" id="p2tel2" value="<?php echo $p2tel2;?>" size="14" onKeyUp="chkno(this);"> <?php echo $lg_fax;?> :
                	<input name="p2fax" type="text" id="p2fax" value="<?php echo $p2fax;?>" size="14" maxlength="10" onKeyUp="chkno(this);"></td>
            </tr>
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			  <td id="myborder" style="border-top:none;border-left:none;border-right:none;">
					<?php echo $lg_email;?></td>
			  <td><input name="p2mel" type="text" id="p2mel" value="<?php echo $p2mel;?>" size="38"><br>Eg. mel@yahoo.com</td>
		  </tr>
          <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
                		<td id="myborder" width="20%"style="border-top:none;border-left:none;border-right:none;">Gambar</td>
                       	<td><input type="file" name="p2pic">(Tidak melebihi 100KB)</td>
          </tr>
</table>
...
<table width="100%" cellspacing="0"  style="background-color:#FFF;">
  <tr>
    <td width="50%" valign="top" id="myborder" style="border-right:none; ">
		<div id="mytitlebg" style="background-color:#FFFF00">E. <?php echo strtoupper($lg_family_information);?></div>
			  <table width="100%"  id="mytitle" style="font-size:10px;">
                <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
                  <td width="1%">&nbsp;</td>
    ...
    <td width="50%" valign="top" id="myborder">
			<div id="mytitlebg" style="background-color:#FFFF00 ">F. <?php echo strtoupper($lg_for_emergency_call);?> (<?php echo $lg_not_parent;?>)</div>
            <table width="100%"  id="mytitle" style="font-size:10px;">
          	<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
			...
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              <td id="myborder" style="border-top:none;border-left:none;border-right:none;">&nbsp;<?php echo $lg_relation;?>*</td>
			 ...
			 <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              ...
              <td ><input name="p3hp" type="text" id="p3hp" value="<?php echo $p3hp;?>" maxlength="10" onKeyUp="chkno(this);"> (<?php echo $lg_no_space_and_dash;?>)</td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              <td id="myborder" style="border-top:none;border-left:none;border-right:none;">&nbsp;<?php echo $lg_tel_home;?></td>
              <td ><input name="p3tel" type="text" id="p3tel" value="<?php echo $p3tel;?>" maxlength="10" onKeyUp="chkno(this);"></td>
            </tr>
            <tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              <td id="myborder" style="border-top:none;border-left:none;border-right:none;">&nbsp;<?php echo $lg_tel_office;?></td>
              <td><input name="p3tel2" type="text" id="p3tel2" value="<?php echo $p3tel2;?>" maxlength="10" onKeyUp="chkno(this);"> </td>
            </tr>
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
              <td id="myborder" style="border-top:none;border-left:none;border-right:none;">&nbsp;<?php echo $lg_fax;?></td>
              <td ><input name="p3fax" type="text" id="p3fax" value="<?php echo $p3fax;?>" maxlength="10" onKeyUp="chkno(this);"></td>
            </tr>
			<tr onMouseOver="this.bgColor='#FAFAFA'" onMouseOut="this.bgColor=''">
