...
if($op=="delete"){
		$sql="update fin_expenses_item set isdel=1,delby='$adm',delts=now() where id='$edit'";
...
if($op=="save"){
		...
		$jumhari=$_REQUEST['jumhari'];
		$jumizin=$_REQUEST['jumizin'];
		$jumsakit=$_REQUEST['jumsakit'];
		$jumalpa=$_REQUEST['jumalpa'];
		
		$jumhadir=$jumhari-$jumizin-$jumsakit-$jumalpa;
		
		
		if($edit>0){
			$sql="update stu_summary set year='$year',lvl='$lvl',sem='$sem',cls='$cls',
				rem1='$jumhari',rem2='$jumizin',rem3='$jumsakit',rem4='$jumalpa',rem5='$jumhadir',adm='$adm',ts=now() where id=$edit";
		}else{
			$sql="insert into stu_summary (type,sid,ic,year,lvl,sem,cls,rem1,rem2,rem3,rem4,rem5,adm,ts)
				values('ATTENDANCE','$sid','$ic','$year','$lvl','$sem','$cls','$jumhari','$jumizin','$jumsakit','$jumalpa','$jumhadir','$adm',now())";
		}
...
<div id="mytitle2">Kehadiran <?php echo $f;?></div>
				...
				<table width="100%" id="mytitle" cellspacing="0" cellpadding="2px" style="font-size:11px">
                    ...
                    <tr onMouseOver="this.bgColor='#F1F1F1'" onMouseOut="this.bgColor=''">
                        <td id="myborderbottom">Jumlah Hari Sekolah</td>
                        <td width="80%"><input name="jumhari" type="text" value="<?php echo $jumhari;?>"></td>
				  	</tr>
                	 <tr onMouseOver="this.bgColor='#F1F1F1'" onMouseOut="this.bgColor=''">
                        <td id="mytabletitle" colspan="2">Tidak Hadir</td>
                        
				  	</tr>
                	 <tr onMouseOver="this.bgColor='#F1F1F1'" onMouseOut="this.bgColor=''">
                        <td id="myborderbottom">Izin</td>
                        <td><input name="jumizin" type="text" value="<?php echo $jumizin;?>"></td>
				  	</tr> 
				    <tr onMouseOver="this.bgColor='#F1F1F1'" onMouseOut="this.bgColor=''">
                        <td id="myborderbottom">Sakit</td>
                        <td><input name="jumsakit" type="text" value="<?php echo $jumsakit;?>"></td>
				  	</tr>                                    
				    <tr onMouseOver="this.bgColor='#F1F1F1'" onMouseOut="this.bgColor=''">
                        <td id="myborderbottom">Alpa</td>
                        <td><input name="jumalpa" type="text" value="<?php echo $jumalpa;?>"></td>
				  	</tr>               
		</table>
</div><!-- story -->
</div><!-- content -->
