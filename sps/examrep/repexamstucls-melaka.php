...
<div id="mytitlebg"><?php if($LG=="BM") echo "LAPORAN PEPERIKSAAN KELAS"; else echo "REPORT CLASS EXAMINATION";?></div>
...
?>
		...
		<?php echo "$tanda$p";?><br>
        	<div style="font-weight:normal"><?php echo "$shortname";?></div>
        </a>
		</td>
<?php } ?>

	<td id="mytabletitle" width="2%" align="center"><a href="#" onClick="clear_newwin();document.myform.sortranking.value=1;process_sort('examrank.total_point <?php echo "$nextdirection";?>','<?php echo "$nextdirection";?>')" title="sort"><?php echo strtoupper($lg_mark);?></a></td>
    <td id="mytabletitle" width="2%" align="center"><a href="#" onClick="clear_newwin();document.myform.sortranking.value=1;process_sort('examrank.total_point <?php echo "$nextdirection";?>','<?php echo "$nextdirection";?>')" title="sort"><?php echo strtoupper($lg_ranking);?></a></td>
...
<?php if($EXAMSLIP_TEACHER_COMMENT){?>
	...
	<?php
				...
				while($row2=mysql_fetch_assoc($res2)){
					...
					$sql="select * from examrank where sch_id=$sid and year='$year' and cls_code='$clscode' and exam='$exam' order by total_point desc";
...
?>
		...
		<td id="myborder" align="center"><?php echo $rank; ?></td>
  </tr>
<?php } }?>
</table>
