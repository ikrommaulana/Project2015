...
?>
  <tr bgcolor="<?php echo $bg;?>" style="cursor:default" onMouseOver="this.bgColor='#CCCCFF';" onMouseOut="this.bgColor='<?php echo $bg?>';" >
	...
	<td id="myborder" align="center">
		<a href="../tk/exam_stu_mark.php?<?php echo "uid=$uid&cls=$clscode&lvl=$clslevel&year=$year&exam=$exam&sid=$sid";?>" target="_blank"><?php echo $uid?></a></td>
	<td id="myborder" align="center"><?php echo $lg_sexmf[$sex];?></td>
	<td id="myborder" >
		<a href="../tk/exam_stu_slip.php?<?php echo "uid=$uid&cls=$clscode&lvl=$clslevel&year=$year&exam=$exam&sid=$sid&smt=$smt";?>" target="_blank"><?php echo $name?></a></td>
	</td>
