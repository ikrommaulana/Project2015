...
?>
           <tr bgcolor="<?php echo $bg;?>" style="cursor:default" onMouseOver="this.bgColor='#CCCCFF';" onMouseOut="this.bgColor='<?php echo $bg?>';" 
  			...
  			<td <?php echo "$bgtd";?> id="myborder" bgcolor="" id="myborder" align="center"  onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
				<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=$surahno";?>" onClick="return GB_showPage('Surah <?php echo addslashes($surahname);?>',this.href)" ><div style="width:100%">&nbsp;<?php echo "$surahname";?></div></a>
			</td>
			<?php
						$sql="select * from surah_stu_read where uid='$uid' and reading>0 order by id desc ";
						$res4=mysql_query($sql)or die("$sql:query failed:".mysql_error());
			...
			<td <?php echo "$bgtd";?> id="myborder"id="myborder" align="center"  onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
				<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=$i";?>" onClick="return GB_showPage('Surah <?php echo addslashes($surahname);?>',this.href)" >
