...
<div align="right">
<input type="button" value="first" onClick="document.myform.isfirst.value='1'; document.myform.submit();" <?php if($stano<=88) echo "disabled";?>>
<input type="button" value="prev" onClick="document.myform.chgno.value='-10'; document.myform.submit();" <?php if($stano<=88) echo "disabled";?>>
...
<table width="100%"  cellspacing="0" cellpadding="2">
 <tr> 
	...
	<td id="mytabletitle" width="5%" align=center style="font-size:8px">32. As Sajdah</td>
    <td id="mytabletitle" width="5%" align=center style="font-size:8px">36. Yaassiin</td>
    <td id="mytabletitle" width="5%" align=center style="font-size:8px">44. Ad Dukhaan</td>
    <td id="mytabletitle" width="5%" align=center style="font-size:8px">56. Al Waaqi'ah</td>
    <td id="mytabletitle" width="5%" align=center style="font-size:8px">62. Al Jumu'ah</td>
    <td id="mytabletitle" width="5%" align=center style="font-size:8px">67. Al Mulk</td>
    <td id="mytabletitle" width="5%" align=center style="font-size:8px">76. Al Insaan</td>


<!--
	<td id="mytabletitle" width="5%" align=center style="font-weight:normal ">HAFAZAN<br>(<?php echo $lg_latest;?>)</td>
	<td id="mytabletitle" width="5%" align=center style="font-weight:normal ">TILAWAH<br>(<?php echo $lg_latest;?>)</td>
-->
 </tr>
	<?php	
...
?>
           <tr bgcolor="<?php echo $bg;?>" style="cursor:default" onMouseOver="this.bgColor='#CCCCFF';" onMouseOut="this.bgColor='<?php echo $bg?>';" onClick="document.myform.uid.value='<?php echo "$uid";?>';newwindow('../ehaf/hafazan_stu_reg.php?uid=<?php echo "$uid";?>&sid=<?php echo "$sid";?>&isprint=1',0)">
				...
				<td id="myborder">
					<a href="../ehaf/amma_sturep.php?uid=<?php echo "$uid&sid=$sid";?>" onClick="return GB_showPage('<?php echo addslashes($name);?>',this.href)" ><?php echo "$name";?></a>
				</td>
                    
				<?php 
						$sql="select * from surah_stu_status where uid='$uid' and surahno=32";
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=32";?>" 
                        	onClick="return GB_showPage('Surah As Sajdah',this.href)" >
                            <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
                    
                    
                    				<?php 
						$sql="select * from surah_stu_status where uid='$uid' and surahno=36";
						$res3=mysql_query($sql)or die("$sql:query failed:".mysql_error());
						$row3=mysql_fetch_assoc($res3);
						$status=$row3['status'];
						$reading=$row3['reading'];
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=36";?>" 
                        	onClick="return GB_showPage('Surah Yaassiin',this.href)" >
                            <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
                    
                    				<?php 
						$sql="select * from surah_stu_status where uid='$uid' and surahno=44";
						$res3=mysql_query($sql)or die("$sql:query failed:".mysql_error());
						$row3=mysql_fetch_assoc($res3);
						$status=$row3['status'];
						$reading=$row3['reading'];
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=44";?>" 
                        	onClick="return GB_showPage('Surah Ad Dukhaan',this.href)" >
                            <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
                    
                                  				<?php 
						$sql="select * from surah_stu_status where uid='$uid' and surahno=56";
						$res3=mysql_query($sql)or die("$sql:query failed:".mysql_error());
						$row3=mysql_fetch_assoc($res3);
						$status=$row3['status'];
						$reading=$row3['reading'];
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=56";?>" 
                        	onClick="return GB_showPage('Surah Al Waaqiah',this.href)" >
                            <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
                    
                                        				<?php 
						$sql="select * from surah_stu_status where uid='$uid' and surahno=62";
						$res3=mysql_query($sql)or die("$sql:query failed:".mysql_error());
						$row3=mysql_fetch_assoc($res3);
						$status=$row3['status'];
						$reading=$row3['reading'];
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=62";?>" 
                        	onClick="return GB_showPage('Surah Al Jumuah',this.href)" >
                            <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
                    
                                        				<?php 
						$sql="select * from surah_stu_status where uid='$uid' and surahno=67";
						$res3=mysql_query($sql)or die("$sql:query failed:".mysql_error());
						$row3=mysql_fetch_assoc($res3);
						$status=$row3['status'];
						$reading=$row3['reading'];
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=67";?>" 
                        	onClick="return GB_showPage('Surah Al Mulk',this.href)" >
                            <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
                    
                    
                 <?php 
							$sql="select * from surah_stu_status where uid='$uid' and surahno=76";
						$res3=mysql_query($sql)or die("$sql:query failed:".mysql_error());
						$row3=mysql_fetch_assoc($res3);
						$status=$row3['status'];
						$reading=$row3['reading'];
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=76";?>" 
                        	onClick="return GB_showPage('Surah Al Insaan',this.href)" >
                            <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
