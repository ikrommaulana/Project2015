...
<table width="100%"  cellspacing="0" cellpadding="2">
 <tr> 
    ...
    <td id="mytabletitle" width="5%" align=center style="font-size:8px"><?php echo "1. Al Fatihah";?></td>
<?php 
	$i=$stano-1;
	$sql="select * from alquran where surahno>=$stano and surahno<=$endno";
	$res=mysql_query($sql)or die("$sql:query failed:".mysql_error());
  	while($row=mysql_fetch_assoc($res)){
...
?>
           <tr bgcolor="<?php echo $bg;?>" style="cursor:default" onMouseOver="this.bgColor='#CCCCFF';" onMouseOut="this.bgColor='<?php echo $bg?>';" 
           		onClick="document.myform.uid.value='<?php echo "$uid";?>';newwindow('../ehaf/hafazan_stu_reg.php?uid=<?php echo "$uid";?>&sid=<?php echo "$sid";?>&isprint=1',0)">
 ...
 <?php   
                $sql="select * from surah_stu_status where uid='$uid' and surahno=1";
...
?>
                <td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=1";?>" onClick="return GB_showPage('Surah Al-Fatihah',this.href)" >
				...
				?>
					<td <?php echo "$bgtd";?>  id="myborder" align="center" onMouseOver="myin(this,1)" onMouseOut="myout(this,1)">
						<a href="../ehaf/surah_stu_reg.php?uid=<?php echo "$uid&sid=$sid&surah=$i";?>" 
                        onClick="return GB_showPage('Surah <?php echo addslashes($surahname);?>',this.href)" >
                        <div style="width:100%">&nbsp;<?php echo "$reading";?></div></a>
					</td>
				<?php } ?>
